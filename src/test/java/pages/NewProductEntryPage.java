...
public class NewProductEntryPage extends basePage{
    ...
    public By  successAlert = By.cssSelector("div.alert.alert-success.alert-dismissable");
    public By  updateAlert = By.xpath("//body/div[2]/div[1]/div[1]/div[1]");
    public By  deleteAlert = By.xpath("//body/div[2]/div[1]/div[1]/div[1]");
